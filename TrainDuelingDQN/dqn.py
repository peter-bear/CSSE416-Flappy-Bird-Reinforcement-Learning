...
class DQN(nn.Module):
    def __init__(self, Dim_in, act_dim):
        ...
        self.value_fc = nn.Linear(in_features=256, out_features=1)  # State value branch
        self.advantage_fc = nn.Linear(in_features=256, out_features=act_dim)  # Action advantage branch
